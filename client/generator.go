...
// Returns "" when the manifest has no pages and no typed shared props —
...
// generatedBanner opens every generated .d.ts; WriteInertiaDTS keys on it
// to tell a generated file from a hand-written one.
